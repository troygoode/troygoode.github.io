---
layout: post
title: npm install cors
excerpt: A node.js package that provides an Express/Connect middleware to enable Cross Origin Resource Sharing (CORS) with various options.
---


CORS is a popular node.js package I've written that provides an [Express](http://expressjs.com/) middleware you can use to enable [CORS](http://en.wikipedia.org/wiki/Cross-origin_resource_sharing) with various options. The code is open source ([MIT License](http://www.opensource.org/licenses/mit-license.php)) and [available on GitHub](https://github.com/troygoode/node-cors).
